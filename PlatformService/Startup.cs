...
namespace PlatformService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                services.AddDbContext<AppDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("PlatformsConnect")));
            }
            else
            {
            ...
            System.Console.WriteLine($"{Configuration["CommandService"]}");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            PreDb.PrepData(app, env.IsProduction());
        }
    }
}
